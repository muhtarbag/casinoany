-- Update handle_new_user function to remove loyalty points award
...
BEGIN
  ...
  -- Create initial loyalty points record (without awarding points)
  INSERT INTO public.user_loyalty_points (user_id, current_points, lifetime_points, tier)
