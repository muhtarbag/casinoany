-- Drop existing notification triggers if they exist
...
-- 1. Notify when user earns points
...
-- 5. Notify blog comment approved
...
-- ============================================
-- CAMPAIGN & SITE OWNER NOTIFICATIONS
-- ============================================
...
BEGIN
  ...
  WHERE bo.is_active = true
    ...
    AND NOT EXISTS (
      ...
      WHERE un.type = 'campaign_expiring'
