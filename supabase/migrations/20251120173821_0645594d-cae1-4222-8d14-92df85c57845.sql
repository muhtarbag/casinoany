...
-- Fix RLS policy for user_loyalty_points to allow trigger insertions
DROP POLICY IF EXISTS "System can insert loyalty points" ON user_loyalty_points;
...
-- Also update handle_new_user to bypass RLS
