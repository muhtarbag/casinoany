      ...
      <CardContent className="p-6 md:p-8">
        <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
          {logoUrl && (
            <div className="flex-shrink-0">
              <img 
                src={logoUrl} 
                alt={`${site.name} logo`} 
                className="w-24 h-24 md:w-32 md:h-32 object-contain rounded-lg bg-card/50 p-2"
              />
            </div>
          )}
          ...
          <div className="flex-1 min-w-0">
            ...
            {site.bonus && (
              <div className="bg-gradient-secondary/10 border border-secondary/30 rounded-lg p-4 mb-4">
            ...
            <Button 
              size="lg" 
              className="w-full md:w-auto bg-gradient-secondary hover:opacity-90 text-lg font-bold shadow-glow-gold"
