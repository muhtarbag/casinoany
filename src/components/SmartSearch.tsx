    ...
    <form onSubmit={handleSearch} className="max-w-2xl mx-auto relative">
      <div className="flex flex-col sm:flex-row gap-2 sm:relative">
        <div className="relative flex-1" ref={suggestionsRef}>
          <Search className="absolute left-4 sm:left-4 top-1/2 -translate-y-1/2 w-5 h-5 sm:w-5 sm:h-5 text-muted-foreground z-10 pointer-events-none" />
          <Input
            type="text"
            ...
            className="pl-14 pr-4 sm:pl-14 sm:pr-28 py-4 sm:py-6 text-base sm:text-lg text-foreground placeholder:text-muted-foreground/70 rounded-lg border-2 border-border focus:border-primary w-full font-normal"
          />
