      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:relative">
        <div className="relative flex-1" ref={suggestionsRef}>
          ...
          <Input
            ...
            className="pl-10 pr-4 sm:pl-12 sm:pr-28 py-4 sm:py-6 text-base sm:text-lg text-foreground placeholder:text-muted-foreground/70 rounded-lg border-2 border-border focus:border-primary w-full font-normal"
          />
