...
// Simple progress bar - avoids Radix UI hook issues
const SimpleProgress = memo(({ value, className }: { value: number; className?: string }) => (
...
export default function CacheManagementPage() {
  ...
  const usagePercent = maxCapacity > 0 ? (totalCapacity / maxCapacity) * 100 : 0;
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <SimpleProgress value={usagePercent} />
              </div>
              ...
              {usagePercent > 80 && (
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    Cache kullanımı yüksek! Temizlik önerilir.
                  </AlertDescription>
                </Alert>
              )}
            </CardContent>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {stats.map((stat) => {
              ...
              const usage = stat.maxSize > 0 ? (stat.size / stat.maxSize) * 100 : 0;
                ...
                <Card key={stat.name}>
                  ...
                  <CardContent className="space-y-3">
                    <div className="space-y-1">
                      ...
                      <SimpleProgress value={usage} className="h-1" />
                    </div>
